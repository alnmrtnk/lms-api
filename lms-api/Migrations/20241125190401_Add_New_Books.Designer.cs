...
namespace lms_api.Migrations
{
    ...
    [Migration("20241125190401_Add_New_Books")]
            ...
            modelBuilder.Entity("lms_api.Application.Borrows.Models.Borrow", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BookId = 1,
                            BorrowDate = new DateTime(2024, 11, 15, 19, 3, 58, 58, DateTimeKind.Utc).AddTicks(266),
                            ReturnDate = new DateTime(2024, 11, 23, 19, 3, 58, 58, DateTimeKind.Utc).AddTicks(283),
                            UserId = 3
                        },
                        new
                        {
                            Id = 2,
                            BookId = 3,
                            BorrowDate = new DateTime(2024, 11, 20, 19, 3, 58, 58, DateTimeKind.Utc).AddTicks(292),
                            UserId = 4
                        });
                });
            ...
            modelBuilder.Entity("lms_api.Application.Reservations.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BookId = 2,
                            ExpirationDate = new DateTime(2024, 11, 26, 19, 3, 58, 58, DateTimeKind.Utc).AddTicks(337),
                            ReservationDate = new DateTime(2024, 11, 24, 19, 3, 58, 58, DateTimeKind.Utc).AddTicks(334),
                            UserId = 3
                        },
                        new
                        {
                            Id = 2,
                            BookId = 4,
                            ExpirationDate = new DateTime(2024, 11, 26, 13, 3, 58, 58, DateTimeKind.Utc).AddTicks(343),
                            ReservationDate = new DateTime(2024, 11, 24, 13, 3, 58, 58, DateTimeKind.Utc).AddTicks(342),
                            UserId = 4
                        });
                });
